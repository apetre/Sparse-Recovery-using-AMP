...
% The packages below are my own additions, nor part of NIPS
...
% This came with the nips template
...
\title{Sparse Singal Recovery \\Using Approximate Message Passing}
